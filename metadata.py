...
def llm_classify(title, files=None, signals=None, preliminary=None):
    ...
    if preliminary:
        ...
        prompt = (
            ...
            "   return 'comics' even if the release is in French and published by Panini, Urban Comics, or Delcourt.\n"
            "2. If the work is originally Japanese manga/manhwa/webtoon, return 'manga'/'manhwa'/'webtoon' "
            "   even if translated to French.\n"
            "3. If the work is an original Franco-Belgian creation (not a translation), return 'bd'.\n"
