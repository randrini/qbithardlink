...
RUN chmod +x /app/hardlink.sh /app/entrypoint.sh /app/bootstrap_categories.py /app/test_release.py /app/test_jikan.py /app/test_providers.py && mkdir -p /app/logs
